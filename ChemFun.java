...
public class ChemFun {
  public static void main(String[] args) {
    ...
    String dict[][] = {
      //format of string: Name, Symbol, Atomic weight, electronic config, Melting point, Boiling point, Group in which the element is present, Period in which the element is present.
